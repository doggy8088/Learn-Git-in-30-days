...
这套是由 [ATLASSIAN](https://www.atlassian.com) 这间公司开发的工具，是一套非常专业的 GUI 操作工具，不仅支持 Git 版本控制，同时也支持 [Mercurial](https://mercurial.selenic.com/) 版本控制机制，这两套版本控制机制都属于分布式版本控制的分类，概念上也十分相近，所以可以整合在这一套工具上使用。
...
* 第一次启动 SourceTree 时，会问你要不要顺便安装 [Mercurial](https://mercurial.selenic.com/)，可装可不装
